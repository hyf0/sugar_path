...
Allocation-sensitive behavior is checked on macOS, Linux, and Windows. See the [benchmark and allocation methodology](https://github.com/hyf0/sugar_path/blob/main/benchmarks/README.md).
