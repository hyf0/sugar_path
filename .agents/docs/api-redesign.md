...
- [x] Replace the historical Linux and Windows-GNU allocation files with final-API Linux and Windows-MSVC snapshots produced by native GitHub Actions and make both native targets continuous gates.
